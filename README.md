...
Project to make an NFL and CFB predictive model based on manual input of an avg. of a 6 second latency input. Quick overview on a vibe-coded site (https://situation-iq-2117583f.base44.app/).
